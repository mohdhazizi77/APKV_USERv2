<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="roasterBM1104.ascx.vb" Inherits="apkv_v2_user.roasterBM1104" %>
<table class="fbform">
...
<%--         <asp:Button ID="btnExport" runat="server" Text="Export " CssClass="fbbutton"/>&nbsp;--%>
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Slip BM setara" CssClass="fbbutton"
