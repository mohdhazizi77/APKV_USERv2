<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="bmsetara_pelajar_ulang_create.ascx.vb" Inherits="apkv_v2_user.bmsetara_pelajar_ulang_create" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">BM Setara &gt;&gt; Pendaftaran Calon Ulang</td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran Calon Ulang</td>
    </tr>
     <tr>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kod Program">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="BM" runat="server" Text='<%# Bind("BM")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="BM3">
                        <ItemTemplate>
                            <asp:Label ID="BM3" runat="server" Text='<%# Bind("BM3")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Batal"> 
                        <ItemTemplate> 
                            <asp:Button ID="btnBatal" runat="server" Text="-" CommandName="Batal" CommandArgument ='<%#Eval("PelajarID")%>'/></td>
                        </ItemTemplate> 
...
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Simpan"> 
                        <ItemTemplate> 
                            <asp:Button ID="btnCreate" runat="server" Text="+" CommandName="Adddata" CommandArgument ='<%#Eval("PelajarID")%>' /></td>
                        </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>  
                </Columns>
    ...
    <tr>
        <td>
            <asp:Button ID="btnDaftar" runat="server" Text="Daftar" CssClass="fbbutton" Visible="true" />&nbsp;
        </td>
    </tr>
</table>
<br />
