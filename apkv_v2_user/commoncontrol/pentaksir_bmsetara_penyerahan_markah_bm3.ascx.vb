...
Public Class pentaksir_bmsetara_penyerahan_markah_bm3
    ...
    Private Sub StatusHantar()
        ...
        strSQL = "  SELECT id FROM kpmkv_pentaksir_bmsetara_calon
                    WHERE StatusSerahBM3KJPP = 'BELUM SERAH'
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            strSQL = "  UPDATE kpmkv_pentaksir_bmsetara_calon
                        SET
                        StatusSerahBM3KJPP = 'TELAH SERAH',
                        StatusSerahBM3KJPPBy = '" & UserID & "',
                        StatusSerahBM3KJPP_timestamp = CURRENT_TIMESTAMP
