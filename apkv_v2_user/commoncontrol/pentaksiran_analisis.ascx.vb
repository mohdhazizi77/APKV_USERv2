...
Public Class pentaksiran_analisis
    ...
    Private Sub tbl_menu_check()
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            Dim PelajarID As String = CType(datRespondent.Rows(i).FindControl("PelajarID"), Label).Text

            strSQL = "SELECT KelasID FROM kpmkv_pelajar Where PelajarID='" & PelajarID & "' AND IsDeleted='N' AND KelasID IS NOT NULL"
    ...
    Private Function getSQL() As String
        ...
        '--not deleted
        tmpSQL = "SELECT kpmkv_pelajar.PelajarID, kpmkv_pelajar.Nama,kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar.Semester,"
        tmpSQL += " kpmkv_pelajar_markah.GredBM, B_BahasaMelayu, A_BahasaMelayu, B_BahasaMelayu3,A_BahasaMelayu3,"
        tmpSQL += " kpmkv_pelajar_markah.GredBI, B_BahasaInggeris, A_BahasaInggeris,"
        tmpSQL += " kpmkv_pelajar_markah.GredSC, B_Science1, A_Science1, B_Science2, A_Science2,"
        tmpSQL += " kpmkv_pelajar_markah.GredSJ, B_Sejarah,A_Sejarah,"
        tmpSQL += " kpmkv_pelajar_markah.GredPI, B_PendidikanIslam1, A_PendidikanIslam1, B_PendidikanIslam2,A_PendidikanIslam2,"
        tmpSQL += " kpmkv_pelajar_markah.GredPM, B_PendidikanMoral,A_PendidikanMoral,"
        tmpSQL += " kpmkv_pelajar_markah.GredMT, B_Mathematics,A_Mathematics,"
        tmpSQL += " kpmkv_pelajar_markah.GredV1,B_Amali1,B_Teori1, A_Amali1,"
        tmpSQL += " kpmkv_pelajar_markah.GredV2, B_Amali2,B_Teori2, A_Amali2,"
        tmpSQL += " kpmkv_pelajar_markah.GredV3, B_Amali3,B_Teori3, A_Amali3,"
        tmpSQL += " kpmkv_pelajar_markah.GredV4, B_Amali4,B_Teori4, A_Amali4,"
        tmpSQL += " kpmkv_pelajar_markah.GredV5, B_Amali5,B_Teori5, A_Amali5,"
        tmpSQL += " kpmkv_pelajar_markah.GredV6, B_Amali6,B_Teori6, A_Amali6,"
        tmpSQL += " kpmkv_pelajar_markah.GredV7, B_Amali7,B_Teori7, A_Amali7,"
        tmpSQL += " kpmkv_pelajar_markah.GredV8, B_Amali8,B_Teori8, A_Amali8,"
        tmpSQL += " PNGBM,PNGKBM,PNGA,PNGKA,PNGV,PNGKV,PNGK,PNGKK,"
        tmpSQL += " GredBMSetara, SMP_Grade"
    ...
    Private Sub ExportToCSV(ByVal strQuery As String)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Pentaksiran_Analisis_'" & ddlSemester.Text & "'.csv")
        Response.Charset = ""
