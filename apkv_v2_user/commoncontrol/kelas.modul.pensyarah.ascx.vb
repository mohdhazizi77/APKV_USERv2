...
Public Class kelas_modul_pensyarah
    ...
    Private Function BindData(ByVal gvTable As GridView) As Boolean
        ...
        Try
            ...
            If myDataSet.Tables(0).Rows.Count = 0 Then
                ...
                'lblmsg.Text = "Rekod Modul tidak dijumpai!"
                ' ''Else
    ...
    Private Function getSQL() As String
        ...
        If Not ddlKodKursus.Text = "" Then
            strWhere += " AND KursusID='" & ddlKodKursus.SelectedValue & "'"
        End If
    ...
    Private Function BindData2(ByVal gvTable As GridView) As Boolean
        ...
        Try
            ...
            If myDataSet.Tables(0).Rows.Count = 0 Then
                'divMsg.Attributes("class") = "error"
                'lblmsg.Text = "Rekod Pensyarah tidak dijumpai!"
                ''Else
                '    divMsg.Attributes("class") = "info"
                '    lblmsg.Text = "Jumlah Rekod#:" & myDataSet.Tables(0).Rows.Count
            End If
    ...
    Protected Sub datRespondent2_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles datRespondent2.RowCommand
        If (e.CommandName = "Pilih") Then
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If isChecked Then
                    strSQL = "SELECT * FROM kpmkv_pensyarah_modul WHERE KelasID='" & ddlNamaKelas.SelectedValue & "' And KursusID='" & ddlKodKursus.SelectedValue & "' And ModulID='" & str & "' "
                    strRet = oCommon.isExist(strSQL)
                    If strRet = True Then

                        strSQL = "DELETE FROM kpmkv_pensyarah_modul WHERE KelasID='" & ddlNamaKelas.SelectedValue & "' And KursusID='" & ddlKodKursus.SelectedValue & "' And ModulID='" & str & "' "
                        strRet = oCommon.getFieldValue(strSQL)
                    End If

                    strSQL = "INSERT INTO kpmkv_pensyarah_modul(PensyarahID, KelasID, KursusID, ModulID, IsDeleted)"
                    strSQL += " VALUES('" & PensyarahID & "', '" & ddlNamaKelas.SelectedValue & "', '" & ddlKodKursus.SelectedValue & "', '" & str & "', 'N')"
