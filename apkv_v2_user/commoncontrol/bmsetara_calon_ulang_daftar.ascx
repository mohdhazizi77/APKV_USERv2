<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="bmsetara_calon_ulang_daftar.ascx.vb" Inherits="apkv_v2_user.bmsetara_calon_ulang_daftar" %>
<script type = "text/javascript">
    function Confirm() {
        var confirm_value = document.createElement("INPUT");
        confirm_value.type = "hidden";
        confirm_value.name = "confirm_value";
        if (confirm("Adakah anda pasti untuk mendaftar Calon Ulang?")) {
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran Calon Ulang>> BM Setara/Sejarah</td>
    </tr>
</table>
<br />
<table class="fbform">
    ...
    <tr>
        <td>Semester:</td>
        <td><asp:DropDownList ID ="ddlsemester" runat ="server" AutoPostBack="true" Width="350px"  >
...
<table class="fbform">
    ...
    <tr>
     ...
     <tr>
        ...
        <td><asp:DropDownList ID="ddlTahunSemasa" runat="server" Width="150px"></asp:DropDownList>
           
            </td>
         </tr>
    <tr>
        <td>Mata Pelajaran:</td>
        <td><asp:DropDownList ID ="ddlmp" runat ="server" >
            <asp:ListItem Value ="BM">BM SETARA</asp:ListItem>
            <asp:ListItem Value ="SJ">SEJARAH</asp:ListItem>
            </asp:DropDownList>
            &nbsp; 
        <asp:Button ID="btnConfirm" runat="server"  CssClass="fbbutton" OnClick = "OnConfirm" Text = "Daftar Ulang" OnClientClick = "Confirm()"/>
        </td>
    </tr>
     <tr>
        <td colspan="2">
