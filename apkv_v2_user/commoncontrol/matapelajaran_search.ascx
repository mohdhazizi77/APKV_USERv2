<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="matapelajaran_search.ascx.vb" Inherits="apkv_v2_user.matapelajaran_search" %>
<table class="fbform">
    ...
    <tr>
        <td>Kohort:</td>
         <td>
            <asp:DropDownList ID="ddlTahun" runat="server" AutoPostBack="false" Height="16px" Width="358px">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
         ...
         <td>
            <asp:DropDownList ID="ddlKodMataPelajaran" runat="server" AutoPostBack="false" Height="16px" Width="355px">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
