<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pelajar_ulang_vokasional.ascx.vb" Inherits="apkv_v2_user.pelajar_ulang_create" %>
<table class="fbform">
        ...
        <td>
          <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="GredV 2">
                        <ItemTemplate>
