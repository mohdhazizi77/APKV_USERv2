<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pensyarah_search.ascx.vb" Inherits="apkv_v2_user.pensyarah_search" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Carian Dan Penyelengaraan >> Pensyarah >> Senarai Pensyarah</td>
    </tr>
</table>
<br />
<table class="fbform">
