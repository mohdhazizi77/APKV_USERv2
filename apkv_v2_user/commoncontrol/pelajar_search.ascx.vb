...
Partial Public Class pelajar_search
        ...
        Try
            If Not IsPostBack Then
                ...
                If oCommon.isExist(strSQL) = True Then
                    ...
                    Dim cmd As New SqlCommand("SELECT TakwimID FROM kpmkv_takwim WHERE Tahun='" & Now.Year & "' AND SubMenuText='Calon' AND Aktif='1'")
                    ...
                    For i As Integer = 0 To dt.Rows.Count - 1
                        ...
                        If strMula IsNot Nothing Then
                            ...
                            ElseIf strAkhir IsNot Nothing And dayDiff < 0 And exist = "0" Then
                                ...
                                lblMsg.Text = "Calon telah ditutup!"
                            End If
                        End If
    ...
    Private Sub kpmkv_status_list()
        strSQL = "SELECT StatusID,Status FROM kpmkv_status ORDER BY Status"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Sub kpmkv_kelas_list()
        ...
        Try
            ...
            '--ALL
            ddlNamaKelas.Items.Insert(0, New ListItem("-Pilih-", "0"))
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE kpmkv_pelajar.IsDeleted='N' AND kpmkv_pelajar.KolejRecordID='" & lblKolejID.Text & "'"
        ...
        If Not ddlStatus.SelectedValue Then
            strWhere += " AND kpmkv_pelajar.StatusID='" & ddlStatus.SelectedValue & "'"
        End If
