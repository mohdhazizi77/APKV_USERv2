...
Public Class notifikasi_PBA
    ...
    Private Sub pbv()
        Try
            ...
            strSQL += " And SubMenuText ='Pentaksiran Berterusan Akademik' AND Aktif='1' ORDER BY Kohort ASC"
            ...
            If numrows > 0 Then
                For i = 0 To numrows - 1
                    ...
                    strSQL += " WHERE m.tahun='" & strKohortText & "' AND (m.isSahPBA='0' OR m.isSahPBA IS NULL) "
                    ...
                    For k = 0 To numrows1 - 1
                        ...
                        strMenu += "<a href='markah.create.PBA.aspx?VKohort=" + strKohort + "&VSemester=" + strSemester + "&VSesi=" + strSesi + "&VKod=" + strKodKursus + "'>" & strKodKursus & "</td>"
                        strMenu += "</tr>"
