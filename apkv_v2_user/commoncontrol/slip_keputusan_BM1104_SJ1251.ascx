<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="slip_keputusan_BM1104_SJ1251.ascx.vb" Inherits="apkv_v2_user.slip_keputusan_BM1104_SJ12511" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlKursus" runat="server" AutoPostBack="true" Width="350px"></asp:DropDownList></td>
    </tr>
    <tr>
