<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="import_markah_matapelajaran.ascx.vb" Inherits="apkv_v2_user.import_markah_matapelajaran" %>
<table class="fbform">
    ...
    <tr>
        <td>Markah: </td>
        <td>
            <asp:CheckBoxList ID="chkResult" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
...
<div id="divImport" runat="server">
    <table class="fbform">
        <tr class="fbform_header">
            <td colspan="2">Import Markah Akademik
            </td>
        </tr>
