<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admin_reportNegeriKV.ascx.vb" Inherits="apkv_v2_user.admin_reportNegeriKV" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan ="2">Senarai bagi Tahun:  <asp:Label ID="lblTahun" runat="server" Text=""></asp:Label>
            </td>
        </tr>
       <tr>
        <td>
