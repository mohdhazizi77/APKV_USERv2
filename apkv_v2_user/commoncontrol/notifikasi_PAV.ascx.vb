...
Public Class notifikasi_PAV
    ...
    Private Sub pbv()
        Try
            ...
            strSQL += " And SubMenuText ='Penilaian Akhir Vokasional' AND Aktif='1' ORDER BY Kohort ASC"
            ...
            If numrows > 0 Then
                For i = 0 To numrows - 1
                    ...
                    strSQL += " WHERE m.tahun='" & strKohortText & "' AND (m.isSahPAV='0' OR m.isSahPAV IS NULL) "
                    ...
                    For k = 0 To numrows1 - 1
                        ...
                        strMenu += "<a href='markah.create.PAV.aspx?VKohort=" + strKohort + "&VSemester=" + strSemester + "&VSesi=" + strSesi + "&VKod=" + strKodKursus + "'>" & strKodKursus & "</td>"
                        strMenu += "</tr>"
