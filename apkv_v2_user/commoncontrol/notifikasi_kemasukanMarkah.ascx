<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="notifikasi_kemasukanMarkah.ascx.vb" Inherits="apkv_v2_user.notifikasi_kemasukanMarkah" %>
...
<table style ="width :100%;padding : 5px;font-weight :bold;background :#990000;color:white  ">
    <tr >
        <td colspan ="4">Notifikasi Kemasukan Markah
            ...
            | <span style ="color :yellow">PB Vokasional</span> 
