<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah.ulang.vokasional.ascx.vb" Inherits="apkv_v2_user.markah_ulang_vokasional" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Markah Ulang Vokasional</td>
    </tr>
     <tr>
