...
Public Class pensyarah_list
    ...
    Private Sub kpmkv_status_list()
        strSQL = "SELECT Status,Kod FROM kpmkv_status WITH (NOLOCK) ORDER BY Kod"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WITH (NOLOCK) WHERE IsDeleted='N' AND KolejRecordID='" & lblKolejID.Text & "'"
        ...
        '--Status
        If Not ddlStatus.Text = "ALL" Then
            strWhere += " AND Status='" & ddlStatus.SelectedValue & "'"
        Else
    ...
    Private Sub btnExecute_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExecute.Click
        Response.Redirect("pensyarah.import.aspx")
    End Sub

    '---Import Pensyarah Baru
    Private Sub Execute_01()
        Response.Redirect("pensyarah.import.aspx?RecordID=" & Request.QueryString("RecordID"))
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("pensyarah.view.aspx?RecordID=" & strKeyID)

    End Sub

    Protected Sub btnDaftar_Click(sender As Object, e As EventArgs) Handles btnDaftar.Click
        Response.Redirect("pensyarah.create.aspx?RecordID=" & lblKolejID.Text)
