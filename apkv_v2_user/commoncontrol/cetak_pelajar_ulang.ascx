<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cetak_pelajar_ulang.ascx.vb" Inherits="apkv_v2_user.cetak_pelajar_ulang1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Cetak Pelajar Ulang</td>
    </tr>
    <tr>
