<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pengesahan_pendaftaran.ascx.vb" Inherits="apkv_v2_user.pengesahan_pendaftaran1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pengesahan Pendaftaran Pelajar</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><asp:DropDownList ID ="ddlStatus" runat ="server"  AutoPostBack ="true" >
            <asp:ListItem Value ="">Belum Disahkan</asp:ListItem>
            <asp:ListItem Value ="Y">DiSahkan</asp:ListItem>
       </asp:DropDownList></td>
    </tr>
    <tr>
         <td colspan="2">
...
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Agama">
                     ...
                     <asp:TemplateField HeaderText="Sah">
                        <ItemTemplate>
                            <asp:Label ID="IsSahkan" runat="server" Text='<%# Bind("IsSahkan")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField >
                         <HeaderTemplate >
    ...
    <tr>
         <td colspan ="2"><asp:Button ID ="btnSah" runat ="server" Text ="Sahkan Pengesahan" CssClass="fbbutton" /> &nbsp; &nbsp; <asp:Button ID ="btnBatal" runat ="server" Text ="Batal Pengesahan" CssClass="fbbutton" /> </td>
    </tr>
    </table>
<br />
<table class="fbform">
    ...
    <tr style="text-align: center;">
           <td style="width: 10%;">
               Tahun :<asp:DropDownList ID="ddlTahun_Semasa" runat="server" AutoPostBack="false" Width="53px" Height="17px"></asp:DropDownList> &nbsp;
               Sesi : <asp:DropDownList ID="ddlSesi_Semasa" runat="server" AutoPostBack="false" >
    ...
    <tr>
         <td style="text-align: center;" colspan="3"><asp:Button ID="btnPrint" runat="server" Text="Cetak Slip Pengesahan" CssClass="fbbutton"/>&nbsp;<asp:HyperLink ID="hyPDF" runat="server" Target="_blank"
