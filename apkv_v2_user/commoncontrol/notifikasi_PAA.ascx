<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="notifikasi_PAA.ascx.vb" Inherits="apkv_v2_user.notifikasi_PAA" %>
<%-- PB Aka --%>
<table style ="width :100%;padding : 5px;font-weight :bold;background :#990000;color:white  ">
    <tr >
        <td colspan ="4">Notifikasi Kemasukan Markah
            ...
            | <span style ="color :yellow"> PA Akademik</span>
